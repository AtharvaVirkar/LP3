...
{
  count++;  // Initial function call count
  if (n <= 1) 
  {
    return n;
  }
...
int main() 
{
  ...
  cout << "\nFibonacci number using recursive approach: " << result_recursive << endl;
  ...
  cout << "\nFibonacci number using iterative approach: " << result_iterative << endl;
